...
- [`rules/repo-shape.md`](rules/repo-shape.md) — adresárová štruktúra a kde čo patrí
- [`rules/commands.md`](rules/commands.md) — npm skripty pre klient + server
- [`rules/architecture.md`](rules/architecture.md) — frontend + backend architektúra
- [`rules/pwa.md`](rules/pwa.md) — Service Worker, manifest, offline
- [`rules/conventions.md`](rules/conventions.md) — API error shape, AI/OCR usage, logy
- [`rules/env-vars.md`](rules/env-vars.md) — environment premenné
